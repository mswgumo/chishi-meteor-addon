package dev.mswgumo.chishi.meteor.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(ChiShiAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
